...
def _generate_unique_filename(cls, func_name):
    ...
    """
    return "<attrs generated {0} {1}.{2}>".format(
        func_name,
        cls.__module__,
...
def _make_init(
    ...
    for a in attrs:
        ...
        if a.on_setattr is not None and frozen is True:
            raise ValueError("Frozen classes can't use on_setattr.")

        elif (
            a.on_setattr is not None
            or has_cls_on_setattr
            and a.on_setattr is not setters.NO_OP
        ):
